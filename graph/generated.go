	...
	return func(ctx context.Context) graphql.Marshaler {
		...
		case res, ok := <-resTmp.(<-chan *model.Time):
			...
			return graphql.WriterFunc(func(w io.Writer) {
				...
				w.Write([]byte{':'})
				ec.marshalNTime2ᚖgithubᚗcomᚋsongtomtomᚋgqlgenᚑapolloᚑsubscriptionsᚋgraphᚋmodelᚐTime(ctx, field.Selections, res).MarshalGQL(w)
				w.Write([]byte{'}'})
			})
		case <-ctx.Done():
			return nil
...
func (ec *executionContext) marshalNTime2githubᚗcomᚋsongtomtomᚋgqlgenᚑapolloᚑsubscriptionsᚋgraphᚋmodelᚐTime(ctx context.Context, sel ast.SelectionSet, v model.Time) graphql.Marshaler {
	return ec._Time(ctx, sel, &v)
}

func (ec *executionContext) marshalNTime2ᚖgithubᚗcomᚋsongtomtomᚋgqlgenᚑapolloᚑsubscriptionsᚋgraphᚋmodelᚐTime(ctx context.Context, sel ast.SelectionSet, v *model.Time) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
